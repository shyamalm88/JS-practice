class BinarySearchTree {
  ...
  delete(data) {
    if (this.root) this.root = this.root.delete(data);
  }
...
class Node {
  ...
  find(data) {
    ...
    else if (data < this.data && this.left != null) return this.left.find(data);
  ...
  insert(data) {
    if (this.data == data) throw new Error("Data already exist within tree");
